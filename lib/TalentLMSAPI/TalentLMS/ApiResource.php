...
abstract class TalentLMS_ApiResource
{
    ...
    protected static function _classUrlByMethodName($method)
    {
        if ($method == 'leafsAndCourses') {
            ...
            if ($method == 'customRegistrationFields') {
                return "/getcustomregistrationfields";
            } else {
                if ($method == 'userSetStatus') {
                    return "/usersetstatus";
                } else {
                    if ($method == 'branchSetStatus') {
                        return "/branchsetstatus";
                    } else {
                        if ($method == 'gotoCourse') {
                            return "/gotocourse";
                        } else {
                            if ($method == 'addUserToGroup') {
                                return "/addusertogroup";
                            } else {
                                if ($method == 'removeUserFromGroup') {
                                    return "/removeuserfromgroup";
                                } else {
                                    if ($method == 'addCourseToGroup') {
                                        return "/addcoursetogroup";
                                    } else {
                                        if ($method == 'addUserToBranch') {
                                            return "/addusertobranch";
                                        } else {
                                            if ($method == 'addCourseToBranch') {
                                                return "/addcoursetobranch";
                                            } else {
                                                if ($method == 'forgotUsername') {
                                                    ...
                                                    if ($method == 'forgotPassword') {
                                                        ...
                                                        if ($method == 'users') {
                                                            ...
                                                            if ($method == 'getRateLimit') {
                                                                return "/ratelimit";
                                                            } else {
                                                                if ($method == 'getUsersProgressInUnits') {
                                                                    return "/getusersprogressinunits";
                                                                } else {
                                                                    if ($method == 'getTestAnswers') {
                                                                        return "/gettestanswers";
                                                                    } else {
                                                                        if ($method == 'getSurveyAnswers') {
                                                                            return "/getsurveyanswers";
                                                                        } else {
                                                                            if ($method == 'getUserStatusInCourse') {
                                                                                return "/getuserstatusincourse";
                                                                            } else {
                                                                                if ($method == 'customCourseFields') {
                                                                                    return "/getcustomcoursefields";
                                                                                } else {
                                                                                    if ($method == 'getCoursesByCustomField') {
                                                                                        return "/getcoursesbycustomfield";
                                                                                    } else {
                                                                                        if ($method == 'getTimeline') {
                                                                                            return "/gettimeline";
                                                                                        } else {
                                                                                            if ($method == 'removeUserFromCourse') {
                                                                                                return "/removeuserfromcourse";
                                                                                            } else {
                                                                                                if ($method == 'getUsersByCustomField') {
